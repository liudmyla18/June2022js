...
//   simpsonName.innerText = `${simpson.name}, age ${simpson.age}`;
//   div.appendChild(simpsonName);
//
//   let simsonInfo = document.createElement(`p`);
//   simsonInfo.innerText = `${simpson.info}`;
//   div.appendChild(simsonInfo);
//
//   let simsonPhoto = document.createElement(`img`);
//   simsonPhoto.src = simpson.photo
//   div.appendChild(simsonPhoto);
//
//
